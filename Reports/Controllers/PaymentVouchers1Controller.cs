...
//                    ChequeNo = "B2C"
//                },
//                Items = new List<PaymentVoucherItem> { new PaymentVoucherItem() }, // Start with one empty item
...
//            PaymentVoucherWithFilesViewModel model,
...
//                // Ensure voucher has proper values (like EditWithFiles does)
...
//                // --- Handle Descriptions --- (like EditWithFiles)
...
//                // --- Handle Items --- (like EditWithFiles)
//                if (model.Items != null && model.Items.Any())
//                {
//                    // Clear any existing items and add new ones
...
//                        // Calculate amount using the same formula as EditWithFiles
...
//                // Calculate totals (like EditWithFiles)
