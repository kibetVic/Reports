    ...
    public class UserAccountsController : Controller
    {
       ...
       // [Authorize]
        ...
        public async Task<IActionResult> Login(LoginViewModel model, bool rememberMe = false)
        {
            ...
            // ✅ Ensure role is valid (just in case)
            if (!Enum.IsDefined(typeof(UserRole), user.Role))
            {
                user.Role = UserRole.User;
            ...
            // ✅ Convert enum to string once
            var roleName = user.Role.ToString();

            // ✅ Create Claims (used by authentication)
            ...
            // ✅ Store session data for UI convenience
